...
@interface WaitDiscussViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WaitDiscussViewController
...
{
    NSString *parameterstring = [NSString stringWithFormat:@"\"deal_status\":\"%@\",\"max\":\"%lu\",\"page\":\"%lu\",\"access_token\":\"%@\"",@"4",(unsigned long)self.max,(unsigned long)self.page,[UseInfo shareInfo].access_token];
