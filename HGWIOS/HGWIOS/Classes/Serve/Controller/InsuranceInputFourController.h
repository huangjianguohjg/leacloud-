//
//  InsuranceInputFourController.h
//  HGWIOS
//
...
@interface InsuranceInputFourController : BaseViewController<AFFNumericKeyboardDelegate,UITextFieldDelegate,RadioButtonDelegate>
...
//邮寄地址
@property (strong, nonatomic) NSString *addressId;//邮寄地址id
@property (strong, nonatomic) NSString *addressIdS;//邮件地址
...
@property ( nonatomic) Boolean isNeedAddress;//发票传递过来的值
