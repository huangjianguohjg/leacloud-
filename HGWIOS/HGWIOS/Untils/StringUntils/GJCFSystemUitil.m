...
//    }
        ...
        if ([originObject isEqual:[NSNull null]] || [anObject isEqual:[NSNull null]]) {
            return;
        }
...
//        return nil;
//    }
    if ([originObject isEqual:[NSNull null]] || [associateKey isEqual:[NSNull null]]) {
        return nil;
    }
...
{
    if ([originObject isEqual:[NSNull null]]) {
        return;
    }
